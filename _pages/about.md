...
<div id="magicOverlay" style="display: none; opacity: 0; transition: opacity 0.5s ease; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(50, 42, 34, 0.72); z-index: 99999; flex-direction: column; justify-content: center; align-items: center; font-family: 'Inter', 'Helvetica Neue', sans-serif; backdrop-filter: blur(5px) saturate(95%) brightness(0.72); -webkit-backdrop-filter: blur(5px) saturate(95%) brightness(0.72); padding: 20px;">
