...
<div id="magicOverlay" style="display: none; opacity: 0; transition: opacity 0.5s ease; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(60, 50, 40, 0.52); z-index: 99999; flex-direction: column; justify-content: center; align-items: center; font-family: 'Inter', 'Helvetica Neue', sans-serif; backdrop-filter: blur(3px) saturate(105%) brightness(0.9); -webkit-backdrop-filter: blur(3px) saturate(105%) brightness(0.9); padding: 20px;">
